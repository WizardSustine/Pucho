...
public class ContratoSQL {
    public ContratoSQL(){}
    public static final class ENTRADAS implements BaseColumns {
        public static final String NOMBRE_TABLA = "PUCHOS";
    ...
    public static final class EXPECTATIVAS implements BaseColumns {
        ...
        public static final String COLUMNA_ULTIMA = "FECHAULTIMA";
    ...
    public static final String SQL_CREATE_ENTRIES_EXP =
            ...
            EXPECTATIVAS.COLUMNA_ULTIMA + " TEXT," +
