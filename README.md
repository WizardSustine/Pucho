...
La aplicación está basada en JAVA con SQLite. Su diseño es sencillo, con solo 2 actividades. La principal tiene 2 fragmentos alternables donde muestro una lista y un gráfico y la segunda para ingresar datos. Cuenta un servicio de notificaciones, para las cuales solicita el permiso al usuario, y desde la misma notificación se puede seleccionar una acción de agregar el consumo.
